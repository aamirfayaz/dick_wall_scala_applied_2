...
class Module08 extends KoanSuite with Matchers with SeveredStackTraces {
  ...
  koan("Fun2 with top types of values") {
    val lots: Any = 1000
    val less: Any = 100.0
  ...
  koan("Fun3 with top types of fudges") {
